...
const cards = [
    // ----- COMMON -----
    {id:"id", rarity:"Rarity", type:"Type", method:"Method", name:"Card Name", artist:"Artist",
    ...
    {id:"c10", rarity:"Common", type:"Charm", method:"Manual", name:"Lil' Appy", artist:"skooptroop",
    description:"[+1] Token for each art drawn<br>for {Friend Pass} this month<br>//(Max of [50])//"},
    {id:"c11", rarity:"Common", type:"Charm", method:"Manual", name:"Comforting Company", artist:"artsy_the_ghost",
    ...
    description:"[+2] card slots<br>[Self-destructs] after using a {Charm}"},
    // ----- RARE -----
